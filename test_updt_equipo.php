                            ...
                            <table id="tabla_equipos" class="table table-bordered table-condensed table-hover responsive" cellspacing="0" width="100%">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="functions/crud_equipo.php?nombre_equ=<?php echo $datos['nombre_equ']; ?>" value="Modificar" ><img src="images/refresh.png" width="25px" height="25px" ></a>
                                        <a href="functions/crud_equipo.php?nombre_equ=<?php echo $datos['nombre_equ']; ?>" value="Eliminar"  ><img src="images/delete.png" width="25px" height="25px" ></a>
                                        </td>
                                        <?php
                                        }
                                        ?>
