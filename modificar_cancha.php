                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6 mb-3">
                                    ...
                                    <select name="estado" id="estado" class="form-select" required>
                                        <option selected disabled value="">Choose...</option>
                                        <option value="1" <?php if ($datos['estado_cancha'] == 1) { ?> selected <?php } ?>>Disponible</option>
                                        <option value="0" <?php if ($datos['estado_cancha'] == 0) { ?> selected <?php } ?>>Nondisponible</option>
                                    </select>
                                </div>
                                <div class="col-12 col-md-6 mb-3">
