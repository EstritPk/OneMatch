...
function modificar()
{
    ...
    identidad_administrador='".$_POST['identidad_adm']."' , edad_administrador='".$_POST['edad_adm']."' , imagen_administrador='".$_FILES['images']['imagen_adm']."' WHERE rut_admin=".$_POST['rut_adm'];
