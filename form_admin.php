                    ...
                    <form action="functions/crud_admin.php" class="needs-validation" enctype="multipart/form-data" method="POST" novalidate>
                        <div class="row">
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="" id="rut" name="rut_adm" required>
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Los pasajes" id="direccion_adm" name="direccion_adm" required>
                            </div>
                            <div class="col-12 col-md-6 mb-3">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" placeholder="904568774" id="telefono_adm" name="telefono_adm" required>
                            </div>
                            <div class="col-12 col-md-6 mb-3">
