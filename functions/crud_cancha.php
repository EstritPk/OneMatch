...
function crear()
{
    ...
    estado_cancha=".validarCaracteres($_POST['estado_can'])." , nombre_cancha='".validarCaracteres($_POST['nombre_can'])."' ,  imagen_cancha='".validarCaracteres($_FILES['imagen_can']['name'])."'";
