                ...
                <form action="functions/crud_usuario.php" class="needs-validation " enctype="multipart/form-data" method="POST" novalidate>
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="" id="ap_materno_usu" name="ap_materno_usu" required>
                        </div>
                        <div class="col-12 col-md-6 mb-3">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <input type="password" class="form-control" placeholder="" id="clave_usu" name="clave_usu" required>
                        </div>
                        <div class="col-12 col-md-6 mb-3">
                        ...
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <select  name="deporte_usu" id="deporte_usu" class="form-select"  required>
